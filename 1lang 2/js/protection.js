...
// © 2024 dacso.uk - All Rights Reserved
// ========================================
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('keydown', function(e) {
            if (e.key === 'F12' || 
                ...
                console.log('%c© dacso.uk - Website', 'color: #92400e; font-weight: bold;');
                return false;
            }
        });
        ...
        console.log('%c© dacso.uk - Website', 'color: #92400e; font-weight: bold;');
        console.log('%cThis website is protected by copyright.', 'color: #666; font-size: 12px;');
        
        // Add copyright notice to page (subtle, in corner) - REMOVED
        // const copyrightNotice = document.createElement('div');
        // copyrightNotice.innerHTML = '© dacso.uk';
